# from sqlalchemy import Column, String, Time, Boolean, ForeignKey, DateTime, func, UUID
...
#     shift_id = Column(PGUUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
#     name = Column(String(20), nullable=False)  # Morning, Evening, Night
